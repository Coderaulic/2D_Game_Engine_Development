...
BossScreen.prototype.drawCamera = function(camera) {
    ...
    for( i = 0; i < this.mStarFighter.size(); i++ ) {
        this.mStarFighter.getObjectAt(i).draw(camera);
    }
...
BossScreen.prototype.update = function() {
    ...
    var i;
    for (i = 1; i < this.mStarFighter.size(); i++) {
        this.mStarFighter.getObjectAt(i).update(this.mStarFighter.getObjectAt(0));
    }
